...
const CryptoDetails = () => {
  ...
  const cryptoColor = cryptoDetails?.color;
  ...
  return (
    <Col className="coin-detail-container">
      ...
      <LineChart coinHistory={coinHistory} currentPrice={millify(cryptoDetails?.price)} coinName={cryptoDetails?.name} cryptoColor={cryptoColor} />
